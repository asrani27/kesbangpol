        ...
        <div id="layanan" class="content bg-silver" data-scrollview="true">
            <!-- begin container -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel-group m-b-0" id="accordion">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#accordion-1">#1. SURAT REKOMENDASI RISET </a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#accordion-2">#2. SURAT ORGANISASI MASYARAKAT</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#accordion-3">#3. SURAT IZIN SPANDUK</a>
                                    </h4>
                                </div>
        ...
        <div id="profil" class="content" data-scrollview="true">
                <!-- begin container -->
                <div class="container" data-animation="true" data-animation-type="fadeInDown">
                    <h2 class="content-title">Profil Kami</h2>
            ...
            <div id="footer" class="footer">
                <div class="container">
                    ...
                    <p>
                        ...
                        Created by <a href="#">Diskominfotik Banjarmasin</a>
                    </p>
                    <p class="social-list">
