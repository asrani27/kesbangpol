...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action={{route('admin.updatekegiatan', $data->id)}} enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right" name="tanggal" id="datepicker" value="{{\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')}}" name="tanggal">
              </div>
              <!-- /.input group -->
            </div>
            <!-- /.form group -->
