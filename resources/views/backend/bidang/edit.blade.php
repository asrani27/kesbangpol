...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action={{route('admin.updateartikel', $data->id)}} enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <img src="{{url('storage/artikel/'.$data->gambar)}}" width="50px" height="50px">
        </div>
          </div>
          <!-- /.box-body -->
