...
<a href="<?php echo e(route('admin.addlayanan')); ?>" class="btn btn btn-success"><i class="fa fa-plus"></i>  Tambah Info Layanan</a> 
<br /><br />
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
                  <a href=<?php echo e(url("layanan_admin/edit/{$dt->id}")); ?> class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> </a>
                  <a href=<?php echo e(url("layanan_admin/delete/{$dt->id}")); ?> class="btn btn-xs btn-danger"  data-toggle="tooltip" title="Hapus" onclick="return confirm('Yakin Ingin Menghapus Data Ini..?');"><i class="fa fa-trash"></i> </a>
              </td>
            </tr>      
