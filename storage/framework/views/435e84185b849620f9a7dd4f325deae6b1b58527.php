...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action=<?php echo e(route('user.saveriset')); ?> enctype="multipart/form-data" >
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right"  name="tgl_surat" id="datepicker" value=<?php echo e(\Carbon\Carbon::today()->format('m/d/Y')); ?>>
              </div>
            </div>
            <!---- ----------------------------->
            <div class="form-group">
          ...
          <div class="box-footer">
            ...
            <a href="<?php echo e(route('user.riset')); ?>" class="btn btn-danger">Kembali</a>
          </div>
        </form>
      </div>
    </div>
