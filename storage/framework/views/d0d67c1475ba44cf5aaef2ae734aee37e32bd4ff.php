...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action=<?php echo e(route('admin.updategrafik', $data->id)); ?> enctype="multipart/form-data">
          ...
          <div class="box-footer">
            ...
            <a href="<?php echo e(route('admin.grafik')); ?>" class="btn btn-danger">Kembali</a>
          </div>
        </form>
      </div>
    </div>
