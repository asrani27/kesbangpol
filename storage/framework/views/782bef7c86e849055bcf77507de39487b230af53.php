...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action=<?php echo e(route('admin.updateartikel', $data->id)); ?> enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>

          <div class="box-body">
            <div class="form-group">
              <label>Judul</label>
            <input type="text" class="form-control" name="judul" required value="<?php echo e($data->judul); ?>">
            </div>
            <div class="form-group"> 
            ...
            <div class="form-group">
                ...
                <img src="<?php echo e(url('storage/artikel/'.$data->gambar)); ?>" width="50px" height="50px">
        </div>
          </div>
          <!-- /.box-body -->
