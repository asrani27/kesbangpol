...
<a href="/bidang/kegiatan/add" class="btn btn btn-success"><i class="fa fa-plus"></i> Tambah Kegiatan</a>
<br /><br />
    ...
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href=<?php echo e(url("bidang/kegiatan/edit/{$dt->id}")); ?> class="btn btn-xs btn-warning" data-toggle="tooltip"
              title="Edit"><i class="fa fa-edit"></i> </a>
            <a href=<?php echo e(url("bidang/kegiatan/delete/{$dt->id}")); ?> class="btn btn-xs btn-danger" data-toggle="tooltip"
