<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="<?php echo e(route('admin.bidang')); ?>"><i class="fa fa-list"></i> <span>Bidang</span></a></li>
      <li><a href="<?php echo e(route('admin.artikel')); ?>"><i class="fa fa-newspaper-o"></i> <span>Artikel</span></a></li>
      <li><a href="<?php echo e(route('admin.kegiatan')); ?>"><i class="fa fa-calendar-plus-o"></i> <span>Jadwal Kegiatan</span></a>
      </li>
      <li><a href="<?php echo e(route('admin.riset')); ?>"><i class="fa fa-credit-card"></i> <span>Surat Rekomendasi
            Peneltian</span></a></li>
      ...
      <li><a href="<?php echo e(route('admin.saran')); ?>"><i class="fa fa-comments"></i> <span>Saran Digital</span></a></li>
      <li class="treeview">
        <a href="#">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-dashboard"></i> <span>Beranda</span></a></li>
      <li><a href="<?php echo e(route('user.riset')); ?>"><i class="fa fa-credit-card"></i> <span>Surat Rekomendasi
            Peneltian</span></a></li>
