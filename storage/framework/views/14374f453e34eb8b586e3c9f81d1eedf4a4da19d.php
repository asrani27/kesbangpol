...
<div class="auto-style8">
	<table style="width: 100%">
		...
		<br />
			...
			<strong><span class="auto-style25">www.banjarmasinkota.go.id</span></strong></div>
			</td>
		</tr>
	</table>
...
</span></strong><span class="auto-style26"><strong>NOMOR : 072/<?php echo e($dt->nosurat); ?> - 
Sekr/Bakesbangpol</strong></span></p>
<p class="auto-style14"><span class="auto-style23">Membaca&nbsp;&nbsp;&nbsp; : Surat 
dari &nbsp; <?php echo e($dt->data->universitas); ?><br />
Nomor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo e($dt->data->no_surat); ?><br />
...
<table style="width: 100%; height: 125px">
	...
	<tr>
		...
		<td class="auto-style7">
			<?php $__currentLoopData = $dt->data->anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php echo e($a); ?>, 
	...
	<tr>
		...
		<td class="auto-style7"><strong>:</strong></td>
		<td class="auto-style7"><?php echo e($dt->data->universitas); ?></td>
	</tr>
	</table>
</p>
...
<table style="width: 100%">
	<tr>
		<td style="width: 422px" class="auto-style7">Tembusan :<br />
			...
			$no =1;
			?>
			<?php $__currentLoopData = $dt->data->tembusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tembusan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php echo e($no++); ?>. <?php echo e($tembusan); ?><br>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		<br />
		<br />
		<br />
...
<span class="auto-style28">PADA TANGGAL&nbsp;&nbsp;&nbsp;&nbsp; :</span></span><span class="auto-style28"><br />
		</span><span class="auto-style23">

<?php if(strtolower($map->data->jabatan) == 'kepala badan kesbangpol'): ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($map->data->jabatan); ?><br />
		<br />
		<br />
		<br />
		<br />
&nbsp;&nbsp;&nbsp;&nbsp; <strong><?php echo e($map->data->nama); ?></strong><br />
&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($map->data->pangkat); ?><br />
&nbsp;&nbsp;&nbsp;&nbsp; NIP. <?php echo e($map->data->nip); ?> </span></td>

<?php elseif(strtolower($map->data->jabatan) == 'sekretaris'): ?>
