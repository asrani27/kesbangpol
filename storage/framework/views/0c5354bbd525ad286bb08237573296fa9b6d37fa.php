...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="post" action=<?php echo e(route('admin.updatekegiatan', $data->id)); ?> enctype="multipart/form-data">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right" name="tanggal" id="datepicker" value="<?php echo e(\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')); ?>" name="tanggal">
              </div>
              <!-- /.input group -->
            </div>
            <!-- /.form group -->
