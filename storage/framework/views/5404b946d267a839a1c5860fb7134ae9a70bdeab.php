...
<a href="<?php echo e(url('grafikadmin')); ?>" class="btn btn btn-danger">Kembali</a> 
<br /><br />
<div class="box box-danger">
    <div class="box-header">
    <h3 class="box-title">Judul Grafik : <?php echo e($data->judul); ?></h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        ?>
        <tbody>
          <?php $__currentLoopData = $data->datagrafik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
              <td><?php echo e($no++); ?></td>
              <td><?php echo e($dt->label); ?></td>
              <td><?php echo e($dt->value); ?> %</td>
              <td><?php echo e($dt->warna); ?></td>
              <td>
                  <button type="button"  class="btn btn-xs btn-warning  edit-data" data-warna="<?php echo e($dt->warna); ?>"  data-id="<?php echo e($dt->id); ?>" data-label="<?php echo e($dt->label); ?>" data-value="<?php echo e($dt->value); ?>" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> </button>
                  <a href=<?php echo e(url("grafikdata/delete/{$dt->id}")); ?> class="btn btn-xs btn-danger"  data-toggle="tooltip" title="Hapus" onclick="return confirm('Yakin Ingin Menghapus Data Ini..?');"><i class="fa fa-trash"></i> </a>
              </td>
            </tr>      
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" method="post" action=<?php echo e(route('admin.savedatagrafik')); ?>>
                <?php echo e(csrf_field()); ?>

                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Label</label>
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" name="grafik_id" value="<?php echo e($data->id); ?>">
...
<div class="modal fade" id="editData">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" method="post" action=<?php echo e(route('admin.updatedatagrafik')); ?>>
                <?php echo e(csrf_field()); ?>
